module github.com/rsync-ai/backend-orchestrator
...
require (
	...
	github.com/rsync-ai/shared/correlation v0.0.0
...
replace github.com/rsync-ai/shared/correlation => ../shared/go/correlation
